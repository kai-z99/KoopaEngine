...
void KoopaEngine::CreateParticleEmitter(double duration, Vec3 pos, Vec3 scale, Vec4 rotation)
{
    this->renderer->CreateParticleEmitter(duration, pos, scale, rotation);
}
